...
import 'package:pogoda/detailPage.dart';
import 'package:pogoda/extraWeather.dart';
...
class _HomePageState extends State<HomePage> {
  getData() async {
    fetchData(lat, lon, city, lang).then((value) {
      currentTemp = value[0];
                          ...
                          showDialog(
                              ...
                              builder: (BuildContext context) {
                                return AlertDialog(
                                  ...
                                  content: Text(
                                      "Пожалуйста, проверьте название города"),
                                  actions: [
                                    TextButton(
                                        onPressed: () {
