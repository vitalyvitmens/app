...
String appId = "4707c215225f3783a2e45a56dd73e1b2";
//https://api.openweathermap.org/data/2.5/onecall?lat=$lat&lon=$lon&units=metric&appid=$appId
//https://raw.githubusercontent.com/dr5hn/countries-states-cities-database/master/cities.json

Future<List> fetchData(String lat, String lon, String city, String lang) async {
  HttpOverrides.global = MyHttpOverrides();
  var url =
      "https://api.openweathermap.org/data/2.5/onecall?lat=$lat&lon=$lon&units=metric&appid=$appId&lang={ru}";
